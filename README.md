...
| [`mass/spinup-cycle-invariance`](probes/mass/spinup-cycle-invariance) | mass | One repeated annual weather cycle: the evaluation year must agree after five, eight, and nine cycles. | `reference_restless`, `reference_leaky`, `reference_cheater`, `reference_degenerate` |
