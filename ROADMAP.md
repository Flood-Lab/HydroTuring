...
Under constant wet forcing, the final steady block must make Manning friction
slope agree with the declared bed slope when discharge, stage, width, bed
elevation and roughness are read together using the exact rectangular
hydraulic radius. The mean absolute normalized residual may not exceed 5%.
