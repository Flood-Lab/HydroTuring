...
from hydroturing.spec import DIAG_VARS, FLUX_VARS, REPO_ROOT, ROUTING_VARS, STATE_VARS, load_model, load_probe
...
@pytest.mark.parametrize("variable", FLUX_VARS + STATE_VARS + DIAG_VARS + ROUTING_VARS)
