...
from hydroturing.spec import DIAGNOSTIC_VARS, FLUX_VARS, REPO_ROOT, STATE_VARS, load_model, load_probe
...
@pytest.mark.parametrize("variable", FLUX_VARS + STATE_VARS + DIAGNOSTIC_VARS)
