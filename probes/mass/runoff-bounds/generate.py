"""Forcing generator for mass/runoff-bounds: ten years of continental weather
with a real winter, the closure probe's climate, so that the runoff bounds
are asked on a catchment that is water-limited in summer and stores snow
in winter. One variant."""
