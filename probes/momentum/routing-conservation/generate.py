...
temperate weather with an added run of large storms in the second year,
so the routing store is filled hard and then left to drain."""
...
STORM_DAYS = [SPINUP_DAYS + 400 + k for k in (0, 1, 2, 10, 11, 25)]
STORM_MM = 45.0
